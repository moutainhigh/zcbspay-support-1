...
/**
 * TOrderCollectDeta generated by hbm2java
 */
@Entity
@Table(name = "T_ORDER_COLLECT_DETA")
public class OrderCollectDetaDO implements java.io.Serializable {
	...
	public OrderCollectDetaDO() {
	}

	public OrderCollectDetaDO(long tid) {
		this.tid = tid;
	}

	public OrderCollectDetaDO(long tid, Long batchtid, String batchno,
