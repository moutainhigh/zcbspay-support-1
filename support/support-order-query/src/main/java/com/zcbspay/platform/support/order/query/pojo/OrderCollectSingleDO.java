...
public class OrderCollectSingleDO implements java.io.Serializable {
	...
	public OrderCollectSingleDO(long tid, String accesstype, String coopinstiid,
			String merid, String encoding, String txntype, String txnsubtype,
			String biztype, String backurl, String mername, String merabbr,
			String orderid, String txntime, String paytimeout, Long txnamt,
			String currencycode, String debtorbank, String debtoraccount,
			String debtorname, String debtorconsign, String creditorbank,
			String creditoraccount, String creditorname, String proprietary,
			String summary, String orderdesc, String reserved, String respcode,
			String respmsg, String tn, String relatetradetxn, String status,
			String ordercommitime, String syncnotify, String notes,
			String remarks) {
		this.tid = tid;
