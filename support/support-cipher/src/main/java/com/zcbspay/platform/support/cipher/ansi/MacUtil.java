package com.zcbspay.platform.support.cipher.ansi;
...
public class MacUtil {
	...
	public static String byte2hex(int[] b) // 二进制转字符串ASCII码 
	{ 
	...
	public static String createPwd(String cardNo, String pwd, String key) {
		String last6 = cardNo.substring(cardNo.length() - 13,
				cardNo.length() - 1);
		String first2 = "0000";
	 ...
	 * @return 加密后的数据
	 */
	public static String MAC(String key, String vector, String data,int desType) {
		if (key.length() != 16) {
	...
	public static String Mac_919(String key, String vector, String data) {
		...
		String mac = MAC(left, null, data,HEX);
	...
	public static String zpkzakDecode(String codesrc, String key) {
		...
		if (!zpkcheck.equals(checkresultzpk)
				|| !zakcheck.equals(checkresultzak)) {
			return null;
		}
	...
	public static void passwordDecode(String mainKey, String workKeyEnc,
	...
	public static void main(String[] args) {
		String masterKey = "3030303030303030";
		String data = "1234567890ABCDEF";
		String mac = MAC(masterKey, "0000000000000000", data,ASC);
		System.out.println(mac.substring(0,8));
	}
